...
class MainFrameCanvas(QWidget):
    ...
    def create_img(self, cmap='gray', pvmin=0.1, pvmax=99.9):
        ...
        # Create image item       
        self.image_item = pg.ImageItem(self.current_img, axisOrder='row-major', levels=(self.attribute['vmin'], self.attribute['vmax']))
    ...
    def update_img(self, img, pvmin=0.1, pvmax=99.9):
        ...
        if self.image_item is not None:
            ...
            self.image_item.setImage(img, axisOrder='row-major', levels=(self.attribute['vmin'], self.attribute['vmax']))
            self.image_item.setScale(scale)
            self.custom_auto_range()
...
class PlotCanvasOld(QMainWindow):
    def __init__(self, img, parent=None):
        super().__init__(parent)
...
#========== PlotCanvas for FFT ================================================
class PlotCanvasFFTOld(PlotCanvas):
    def __init__(self, img, parent=None):
        # img is the image dictionary, NOT FFT. FFT will be calculated in create_img()
        super().__init__(img, parent)
        fft_menu = self.menubar.children()[3]
...
class PlotCanvasSpectrumOld(QMainWindow):
